...
test('correct answer gives at least 10 points, increases ELO, and HUD updates', async ({ page }) => {
  ...
  expect(pointsFromFeedback).toBeGreaterThanOrEqual(10)
...
test('incorrect answer loses bounded points, decreases ELO, and HUD updates', async ({ page }) => {
  ...
  expect(afterCorrect.score).toBeGreaterThanOrEqual(10)
  ...
  // Loss should be bounded: between 5 and 50
  expect(lossFromFeedback).toBeGreaterThanOrEqual(5)
  expect(lossFromFeedback).toBeLessThanOrEqual(50)
...
test('hard pair (same-day) gives more points than easy pair', async ({ page }) => {
  ...
  expect(easyPoints).toBeGreaterThanOrEqual(10)
  expect(hardPoints).toBeGreaterThanOrEqual(10)
})
